...
function CyberPageHeader({ title, description, icon, className = '', titleHref, homeHref = '/', homeLabel = 'Home', showHomeLink = true, actions, }) {
